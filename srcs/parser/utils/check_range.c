...
/*   Updated: 2023/05/29 20:18:35 by drontome         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	check_rg(void *data, t_range r)
{
	...
	if (r == HFOV && (*f > 180 || *f < 0))
		...
		return (false);
	else if (r == SEGM && (*f > INT_MAX || *f <= 0))
		return (false);
	else if (r == POINT && (v->x > INT_MAX || v->y > INT_MAX || v->z > INT_MAX))
		return (false);
	else if (r == POINT && (v->x < INT_MIN || v->y < INT_MIN || v->z < INT_MIN))
		return (false);
