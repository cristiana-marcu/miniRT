...
#    Updated: 2023/04/18 17:52:40 by cmarcu           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS	=	srcs/canvas/canvas.c ./main.c srcs/vectors.c ./srcs/ray.c srcs/camera.c srcs/render.c srcs/sphere-plane.c srcs/cylinder.c
OBJS	=	$(SRCS:.c=.o)
